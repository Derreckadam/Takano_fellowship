...
p3
```
```{r echo=FALSE, fig.width=4,fig.height=4,fig.cap="This figure shows veterans with and without disablilities living below the poverty line in California Congressional District 41"}
p4
```
...
```
```{r echo=FALSE, out.width = '100%', fig.cap="B.) Blobs dot denoting locations within reach of VA Clinics"}
