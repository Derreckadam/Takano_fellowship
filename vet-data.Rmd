...
![District Populations](./images/population/District_populations.png){width=80%}!   [District Populations legend](./images/population/Districts_legend.png){height=25%}
...
p2 <- ggplot(income.old, aes(x=District, y=income.old$`Population`, fill=income.old$District)) +
  geom_bar(stat= "identity") + ylab("Number of Veterans") + ggtitle("Senior Veterans Below Poverty Line") + guides(fill=guide_legend(title=""))
