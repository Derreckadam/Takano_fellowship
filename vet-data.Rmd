...
# Veteran Overview
In general this doucment with outlines the history of VA facilities in the area, Veteran Needs and demographics, as well as the Capacity, Quality, and Assesibility of nearby CBOCs and VA Medical Centers.
...
library(ggplot2)
library(reshape2)
data <- read_excel("/Volumes/GoogleDrive/My Drive/Takano_fellowship/Data.xlsx", sheet = "LomaLinda_rating_va", range = "A1:W9")
